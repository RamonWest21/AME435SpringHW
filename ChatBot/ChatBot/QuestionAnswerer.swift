struct QuestionAnswerer {
    ...
    func responseTo(question: String) -> String {
        ...
        else if lowerQuestion.hasSuffix("from") || lowerQuestion.hasSuffix("from?") {
            return "From the depths of Jabba's palace."
        }
        else if lowerQuestion.hasPrefix("where are") || lowerQuestion.hasPrefix("where is") {
